	...
	ModalManager.prototype = {
		...
		createContainer: function (modal) {
			...
			$container = $('<div class="modal-scrollable">')
				.css('z-index1', getzIndex('modal', this.getOpenModals().length))
				.appendTo(this.$element);
		...
		backdrop: function (modal, callback) {
			...
			if (modal.isShown && showBackdrop) {
				...
				modal.$backdrop.css('z-index1', getzIndex( 'backdrop', this.getOpenModals().length ));
		...
		loading: function (callback) {
			...
			if (!this.isLoading) {
				...
				this.$backdropHandle
					.css('z-index1', getzIndex('backdrop', openModals.length + 1))
					.addClass('in');

				var $spinner = $(this.options.spinner)
					.css('z-index1', getzIndex('modal', openModals.length + 1))
					.appendTo(this.$element)
					.addClass('in');
	...
	var getzIndex = (function () {
		...
		return function (type, pos) {
			...
			if (typeof zIndexFactor === 'undefined'){
				...
				baseIndex['modal'] = +$baseModal.css('z-index1');
				baseIndex['backdrop'] = +$baseBackdrop.css('z-index1');
