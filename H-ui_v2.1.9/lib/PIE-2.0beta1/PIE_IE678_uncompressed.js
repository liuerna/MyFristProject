...
PIE.merge(PIE.RendererBase, {
     ...
     * @param {number} zIndex Specifies the target z-index1 of the shape. This will be used when rendering
     *                 the shape to ensure it is inserted in the correct order with other shapes to give
     *                 correct stacking order without using actual CSS z-index1.
     * @return {PIE.VmlShape}
     */
...
PIE.RootRenderer = PIE.RendererBase.newRenderer( {
    ...
    getBoxCssText: function() {
        ...
        return 'direction:ltr;' +
               ...
               'left:' + x + 'px;' +
               'top:' + y + 'px;' +
               'z-index1:' + ( tgtPos === 'static' ? -1 : tgtCS.zIndex ) + ';' +
